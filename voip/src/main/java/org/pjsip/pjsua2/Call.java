...
public class Call {
  ...
  public void clearKeyByAndroid() {
    pjsua2JNI.Call_clearKeyByAndroid(swigCPtr, this);
  }
  ...
  public int updateByAndroid(CallOpParam prm) throws java.lang.Exception {
    return pjsua2JNI.Call_updateByAndroid(swigCPtr, this, CallOpParam.getCPtr(prm), prm);
  }
  ...
  public void onCallState(OnCallStateParam prm) {
    try{
      if (getClass() == Call.class) {
        pjsua2JNI.Call_onCallState(swigCPtr, this, OnCallStateParam.getCPtr(prm), prm);
      }else {
        pjsua2JNI.Call_onCallStateSwigExplicitCall(swigCPtr, this, OnCallStateParam.getCPtr(prm), prm);
      }
    }catch (Exception e){
      e.printStackTrace();
    }
