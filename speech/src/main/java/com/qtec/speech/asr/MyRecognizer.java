...
import com.qtec.speech.asr.listener.IRecogListener;
import com.qtec.speech.asr.listener.RecogEventAdapter;
import com.qtec.speech.asr.params.CommonRecogParams;
...
public class MyRecognizer {
    ...
    public MyRecognizer(Context context, EventListener eventListener) {
        ...
        CommonRecogParams commonRecogParams = new CommonRecogParams();
        commonRecogParams.
    }
